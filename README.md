...
## Presentation 
Le but de ce projet est de permettre à l'utilisateur de s'inscrire et de se connecter. Une fois connecté, il saisit des informations qui seront enregistrés dans la base de données, avec un récapitulatif de tous ses choix à la fin.
